...
writer = SummaryWriter('logs/acgan_experiment', max_queue=100)
...
for epoch in range(opt.n_epochs):
    for i, (imgs, labels) in enumerate(dataloader):
        ...
        if batches_done % opt.sample_interval == 0:
            ...
            writer.add_image('train/samples', make_grid(get_sample(10), normalize=True), batches_done)
